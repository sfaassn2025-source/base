...
<ul>
  <li>桃園市政府社會局劉泰良科長</li>
  <li>財團法人工業技術研究院范士展技術經理</li>
  <li>國立高雄大學資訊管理系林杏子副教授</li>
  <li>國立臺北大學社會工作學系胡中宜教授</li>
  <li>數位發展部林哲豪科長</li>
  <li>衛生福利部資訊處盧修文科長</li>
</ul>

<div class="bg-info" style="margin: 24px 0; padding: 20px; font-size: 1.2em; border-radius: 4px;">
  <p>如社政相關業務單位有參與意願，或對資料內容、代碼檔、IG 有任何疑問，歡迎聯繫詹先生（02-26531027）。</p>
</div>
