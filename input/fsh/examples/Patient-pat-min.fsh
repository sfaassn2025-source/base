...
* extension[age].extension[age].valueAge.value = 25
...
* extension[AborigineTribe].valueCodeableConcept.coding[0] = TWSSAborigineTribe#amis "阿美族"
* extension[religion].valueCodeableConcept = http://terminology.hl7.org/CodeSystem/v3-ReligiousAffiliation#1029 "Mahayana"
* communication[0].language.coding[0].system = "http://terminology.hl7.org/CodeSystem/iso639-3"
* communication[0].language.coding[0].code = #ami
...
<div xmlns="http://www.w3.org/1999/xhtml">
  ...
  <p><b>年齡</b>：25 歲<br/><b>年齡記錄日期</b>：2026-08-31</p>
