...
* code.coding[health-status-option].system = "https://sfaa.gov.tw/base/CodeSystem/twss-health-status-option"
* code.coding[health-status-option].code = #5
* code.coding[health-status-option].display = "發展遲緩"
...
<div xmlns="http://www.w3.org/1999/xhtml">
  ...
  <p><b>狀況文字</b>：自閉症</p>
  <p><b>健康狀況選項</b>：發展遲緩 <span style="background: LightGoldenRodYellow; margin: 4px; border: 1px solid khaki">（ <a href="CodeSystem-twss-health-status-option.html">健康狀況選項</a>#5）</span></p>
