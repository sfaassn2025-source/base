Instance: prac-adoption-manager
InstanceOf: PractitionerTWSSBase
Title: "收出養機構負責人範例"
Description: "符合 Practitioner TWSS Base Profile 的收出養機構負責人情境範例。"
Usage: #example
...
* identifier[idCardNumber].value = "D223456789"
* name[0].text = "李負責"
...
<div xmlns="http://www.w3.org/1999/xhtml">
  <h3><b>收出養機構負責人資料</b></h3>
  <blockquote>
    <p><b>識別碼型別</b>：National Person Identifier <span style="background: LightGoldenRodYellow; margin: 4px; border: 1px solid khaki">（ <a href="http://terminology.hl7.org/CodeSystem/v2-0203">Identifier Type Codes</a>#NNxxx）</span><br/><b>身分證字號（official）</b>：D223456789 （http://www.moi.gov.tw）</p>
  </blockquote>
  <p><b>姓名</b>：李負責</p>
