...
* status = #completed
* intent = #order
* businessStatus = TWSSReferralProcessingStatus#completed "轉介完成"
...
<div xmlns="http://www.w3.org/1999/xhtml">
  ...
  <p><b>轉介處理情形</b>：轉介完成 <span style="background: LightGoldenRodYellow; margin: 4px; border: 1px solid khaki">（ <a href="CodeSystem-twss-referral-processing-status.html">TWSS-轉介處理情形代碼系統</a>#completed）</span></p>
