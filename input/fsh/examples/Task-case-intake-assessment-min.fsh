...
* input[caseType].valueCodeableConcept = TWSSCaseType#0 "兒少安置及教養機構"
...
<div xmlns="http://www.w3.org/1999/xhtml">
  ...
  <p><b>評估案件類型</b>：兒少安置及教養機構 <span style="background: LightGoldenRodYellow; margin: 4px; border: 1px solid khaki">（<a href="CodeSystem-twss-case-type.html">TWSS 案件類型</a>#0）</span></p>
