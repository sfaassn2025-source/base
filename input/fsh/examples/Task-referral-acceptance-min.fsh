...
* output[acceptanceDecision].valueCodeableConcept = TWSSReferralAcceptanceStatus#accepted "受案"
...
<div xmlns="http://www.w3.org/1999/xhtml">
  ...
  <p><b>轉介受理情形</b>：<span style="background: LightGoldenRodYellow; margin: 4px; border: 1px solid khaki"><a href="CodeSystem-twss-referral-acceptance-status.html">TWSS-轉介受理情形代碼系統</a>#accepted</span> 受案</p>
</div>
"""
