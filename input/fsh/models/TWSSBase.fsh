...
* subsidyApplication.reviewCheckDate 0..1 dateTime "審核/查核日期" "審核或查核作業完成的日期與時間。"
...
* caseReport.reportingUnit 0..1 CodeableConcept "通報單位及管道" "個案通報的提出單位或管道類別。"
...
* caseAssessment.privateBedroomStatus 0..1 CodeableConcept "獨立臥房狀態" "個案使用獨立或共用臥房的狀態。"
* caseAssessment.currentLivingStatus 0..1 CodeableConcept "生活自理與居住狀態" "個案目前的生活自理與居住狀態。"
...
* caseAssessment.healthAndDiseaseStatus 0..* CodeableConcept "健康與疾病狀況" "健康與疾病狀況。"
...
* caseAssessment.reviewSubmissionDate 0..1 dateTime "送審日期" "服務評估表單送交審核的日期與時間。"
* caseAssessment.reviewCheckDate 0..1 dateTime "審核/查核日期" "個案服務評估審核完成的日期與時間。"
...
* caseAssessment.privateBedroomStatus -> "QuestionnaireResponse.where(questionnaire = 'https://sfaa.gov.tw/base/Questionnaire/living-condition-assessment').item.where(linkId = '1').item.where(linkId = '1.4').answer.valueCoding"
...
* caseAssessment.healthAndDiseaseStatus -> "QuestionnaireResponse.where(questionnaire = 'https://sfaa.gov.tw/base/Questionnaire/health-disease-status').item.where(linkId = '6.4').answer.valueCoding"
...
* caseAssessment.healthAndDiseaseStatus -> "Condition.code.coding[health-and-disease-status]"
